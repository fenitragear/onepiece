           ...
           // require: 'ngModel',
            ...
            link: function ($scope, element, attrs, ngModelCtrl, $compile) {
                ...
                function initSlider() {
                    ...
                    setOption('tooltip', attrs.sliderTooltip || attrs.tooltip, 'always');
                    ...
                    $scope.$watch('sunit', function (newValue, oldValue) {
                        $scope.sunit = newValue;
                    ...
                    if (attrs.formatter) {
                        options.formatter = function(value) {
                            var svalue =  $scope.formatter({value: value});
                            if(($scope.sunit !== undefined) && ($scope.sunit != '')){
                               var unit =  $scope.sunit != 'Aucune' ? $scope.sunit : '';
                                return  svalue.toString().replace(","," à ") + ' ' + unit;
                            }
                            return  svalue;
                        }
