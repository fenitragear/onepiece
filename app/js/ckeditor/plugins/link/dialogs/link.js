...
( function() {
	CKEDITOR.dialog.add( 'link', function( editor ) {
		...
		var targetChanged = function() {
            ...
            if (value === true) value = '_blank';


            if (value !== '_blank' && disableCallStack === false) {
                disableCallStack = true;
                dialog.getContentElement('info', 'linkTargetTypeShortcut').setValue(false);
        ...
        var getFormUrl = function (callback) {
            ...
            $.post('../server/service/baseUrl.php', {session: clientId}, function (data) {
                ...
                linkForm = linkForm.replace(/https?:\/\//, '');
                callback(linkForm, data.formShow);
            }, 'json');
        }
    				...
    				elements: [
        				...
        				},
                        {
                            ...
                            children: [
                                ...
                                {
                                    type: 'checkbox',
                                    id: 'linkTargetTypeShortcut',
                                    label: commonLang.targetNew,
                                    onChange: function (data) {
                                        if (disableCallStack === false) {
                                            if (data.data.value === true) {
                                                targetChanged.call(this);
                                                $('.cke_dialog option[value="_blank"]').parent().val('_blank');
                                            } else if (data.data.value === false) {
                                                targetChanged.call(this);
                                                $('.cke_dialog option[value="notSet"]').parent().val('notSet');
                                            }
                                        }
                                    },
                                    setup: function( data ) {
                                ...
                                },
                                {
                                    type: 'checkbox',
                                    id: 'linkFormShortcut',
                                    label: commonLang.formLink,
                                    onChange: function (data) {
                                        if (data.data.value === true) {
                                            this.getDialog().getContentElement('info', 'url').disable();

                                            getFormUrl(function (link) {
                                                this.getDialog().getContentElement('info', 'url').setValue(link);
                                            }.bind(this));
                                        } else if (data.data.value === false) {
                                    ...
                                    setup: function (data) {
                                        getFormUrl(function (link, formShow) {
                                            if (formShow === false) {
                                                $('#' + this.domId).parent().parent().hide();

                                                if (this.getDialog().getContentElement('info', 'url').getValue() === link) {
                                                    this.setValue(false);
                                                }
                                            } else {
                                                $('#' + this.domId).parent().parent().show();
